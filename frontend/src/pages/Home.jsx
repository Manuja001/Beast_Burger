    ...
    <div className="w-full overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 animate-fadeIn">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 drop-shadow-2xl">
            <span className="block animate-slideDown" style={{ animationDelay: "0.2s" }}>
              BEAST
            </span>
            <span className="block text-orange-600 animate-slideUp" style={{ animationDelay: "0.4s" }}>
              BURGER
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-8 max-w-2xl mx-auto drop-shadow-lg animate-fadeIn" style={{ animationDelay: "0.6s" }}>
            Experience the Ultimate Burger Adventure
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fadeIn" style={{ animationDelay: "0.8s" }}>
            <button className="bg-orange-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-orange-700 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 transform">
              Order Now
            </button>
            <button className="bg-white/10 backdrop-blur-md text-white px-8 py-4 rounded-lg font-bold text-lg border-2 border-white hover:bg-white/20 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 transform">
              View Menu
            </button>
          </div>
        </div>
      ...
      <section
        ...
        className={`min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 to-black transition-all duration-1000 ${
          isVisible.burger1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
        }`}
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div
            className={`order-2 lg:order-1 transition-all duration-1000 delay-300 ${
              isVisible.burger1 ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"
            }`}
          >
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              Our signature Beast Burger is crafted with 100% premium beef, fresh vegetables, and our secret sauce. 
              Every bite is a journey of flavors that will leave you craving for more.
            </p>
          ...
          <div
            className={`order-1 lg:order-2 transition-all duration-1000 delay-500 ${
              isVisible.burger1 ? "opacity-100 translate-x-0 scale-100" : "opacity-0 translate-x-20 scale-95"
            }`}
          >
      ...
      <section
        ...
        className={`min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-900 via-black to-gray-900 transition-all duration-1000 ${
          isVisible.hotdog ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
        }`}
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div
            className={`order-1 transition-all duration-1000 delay-300 ${
              isVisible.hotdog ? "opacity-100 translate-x-0 scale-100" : "opacity-0 -translate-x-20 scale-95"
            }`}
          >
            <div className="relative group">
              <img
          ...
          <div
            className={`order-2 transition-all duration-1000 delay-500 ${
              isVisible.hotdog ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"
            }`}
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              Our classic hotdog is a timeless favorite, made with premium quality sausages and served with your choice of toppings. 
              A perfect blend of tradition and taste.
            </p>
            <ul className="space-y-3 text-gray-300 mb-8">
              <li className="flex items-center">
                <svg className="w-5 h-5 text-orange-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section
        ...
        className={`min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-black via-gray-900 to-orange-900 transition-all duration-1000 ${
          isVisible.burger2 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
        }`}
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div
            className={`order-2 lg:order-1 transition-all duration-1000 delay-300 ${
              isVisible.burger2 ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"
            }`}
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              Double the patties, double the flavor! Our Double Beast Burger features two premium beef patties, 
              double cheese, and all the fixings. For those who dare to go big.
            </p>
            <ul className="space-y-3 text-gray-300 mb-8">
              <li className="flex items-center">
                <svg className="w-5 h-5 text-orange-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div
            className={`order-1 lg:order-2 transition-all duration-1000 delay-500 ${
              isVisible.burger2 ? "opacity-100 translate-x-0 scale-100 rotate-0" : "opacity-0 translate-x-20 scale-95 rotate-3"
            }`}
          >
            <div className="relative group">
              <img
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-600 to-orange-700 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Order now and get your favorite burgers and hotdogs delivered fresh to your door!
          </p>
